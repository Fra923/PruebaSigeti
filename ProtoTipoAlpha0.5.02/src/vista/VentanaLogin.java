    ...
    private void ajustarEventos() {
        ...
        btnIngresar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int u = Controlador.obtenerInstancia().verificaLoggin(txtCorreo.getText(), txtContraseña.getText());
                if (u != 0) {
                    if (u == -1) {
                        JOptionPane.showMessageDialog(null, "El usuario se encuentra bloqueado", "ERROR", JOptionPane.ERROR_MESSAGE);
                        limpiar();
                    } else {
                        Ventana.obtenerInstancia().setTipoUsuario(Integer.toString(u));
                        limpiar();
                        ocultar();
        ...
        lbOlvidoClave.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                limpiar();
                VentanaRecuperaContraseña.obtenerInstancia();
                ocultar();
                Ventana.obtenerInstancia().mostrar();
            }
