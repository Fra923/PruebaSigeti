...
public class PanelConsultaTodosAdmin extends javax.swing.JPanel {

    private PanelConsultaTodosAdmin() {
        initComponents();
        ocultarComponentes();
        iniciarValidaciones();
    }//---------------------------------------------------------------------END_Constructor

    public static PanelConsultaTodosAdmin obtenerInstancia() {//para garantizar hay solo una instancia
        if (instancia == null) {
            instancia = new PanelConsultaTodosAdmin();
        }
        return instancia;
...
//---------------------------------------------------------------------END_eventoCombox
    ...
    private static PanelConsultaTodosAdmin instancia = null;
    //--o--
