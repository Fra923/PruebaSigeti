...
public class PanelTicketProcesoAdmin extends javax.swing.JPanel {

    private PanelTicketProcesoAdmin() {
        initComponents();
    }
    
    private static PanelTicketProcesoAdmin instancia=null;
    
    public static PanelTicketProcesoAdmin obtenerInstancia() {//para garantizar hay solo una instancia
        if (instancia == null) {
            instancia = new PanelTicketProcesoAdmin();
        }
        return instancia;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Tickets en proceso");
