...
import vista.Area.PanelConsultaTodosArea;
...
import vista.administrativo.PanelConsultaTodosAdmin;
...
import vista.administrativo.PanelTicketProcesoAdmin;
...
public class Ventana extends JFrame {//la venta a mostrarse en la interface
    ...
    public void cerrarSesion() {
        ...
        if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this, "Realmente "
                + "desea cerrar sesión", null, JOptionPane.YES_NO_OPTION)) {
            VentanaLogin.obtenerInstancia().mostrar();
            ocultar();
    ...
    public void historialTicketsStandard() {
        ...
        scrollPanelPrincipal = new JScrollPane(PanelConsultaTodos.obtenerInstancia());
        panelPrincipal.setLayout(new BorderLayout());
        panelPrincipal.add(ArbolStandard.obtenerInstancia(), BorderLayout.WEST);
        panelPrincipal.add(scrollPanelPrincipal, BorderLayout.CENTER);
        repaint();
    ...
    public void buscarUltimoTicketStandard() {
        ...
        panelPrincipal.add(scrollPanelPrincipal, BorderLayout.CENTER);
        repaint();
    }//-------------------------------------------FIN_buscarUltimoTicketStandard
    ...
    public void crearTicketStandard() {
        ...
        panelPrincipal.add(scrollPanelPrincipal, BorderLayout.CENTER);
        repaint();
    }//--------------------------------------------------FIN_crearTicketStandard

//==============================================================================
//==============================================================================
//FIN METODOS PARA USUARIO ESTANDAR    
//==============================================================================    
//==============================================================================
//-------------------------------------------------------- METODOS PARA USUARIO DE AREA
    public void historialTicketsArea() {
        panelPrincipal.removeAll();
        setBarraEstado("Historial de tickets");
        scrollPanelPrincipal = new JScrollPane(PanelConsultaTodosArea.obtenerInstancia());
        panelPrincipal.setLayout(new BorderLayout());
        panelPrincipal.add(ArbolArea.obtenerInstancia(), BorderLayout.WEST);
        panelPrincipal.add(scrollPanelPrincipal, BorderLayout.CENTER);
        repaint();
    }//-------------------------------------------------FIN_historialTicketsArea
...
//==============================================================================
//==============================================================================
//--------------------------------------------- FIN METODOS PARA USUARIO DE AREA
//==============================================================================
//==============================================================================
    //-------------------------------------------------------- METODOS PARA USUARIO ADMINISTRADOR
    ...
    public void historialTicketsAdmin() {
        panelPrincipal.removeAll();
        setBarraEstado("Historial de tickets");
        scrollPanelPrincipal = new JScrollPane(PanelConsultaTodosAdmin.obtenerInstancia());
        panelPrincipal.setLayout(new BorderLayout());
        panelPrincipal.add(ArbolAdministrativo.obtenerInstancia(), BorderLayout.WEST);
        panelPrincipal.add(scrollPanelPrincipal, BorderLayout.CENTER);
        pack();
    ...
    public void ticketsProcesoAdmin() {
        ...
        scrollPanelPrincipal = new JScrollPane(PanelTicketProcesoAdmin.obtenerInstancia());
        panelPrincipal.setLayout(new BorderLayout());
        panelPrincipal.add(ArbolAdministrativo.obtenerInstancia(), BorderLayout.WEST);
        panelPrincipal.add(scrollPanelPrincipal, BorderLayout.CENTER);
        pack();
    ...
    //-------------------------------------------------------- FIN METODOS PARA USUARIO ADMINISTRADOR
...
//    }//--------------------------------------------------------------------- FIN olvidoClave()
    ...
    void registrar() {
        desAbilitarMenu();
        PanelRegistrar pRegistro = PanelRegistrar.obtenerInstancia();
        panelPrincipal.removeAll();
        panelPrincipal.setLayout(new FlowLayout(FlowLayout.CENTER));
        panelPrincipal.add(pRegistro, BorderLayout.CENTER);
        setBarraEstado("Creando cuenta nueva");
        panelPrincipal.add(pRegistro);
