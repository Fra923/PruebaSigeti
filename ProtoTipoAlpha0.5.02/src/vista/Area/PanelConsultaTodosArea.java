...
public class PanelConsultaTodosArea extends javax.swing.JPanel {

    private PanelConsultaTodosArea() {
        initComponents();
        ocultarComponentes();
        iniciarValidaciones();
    }//---------------------------------------------------------------------END_Constructor

    public static PanelConsultaTodosArea obtenerInstancia() {//para garantizar hay solo una instancia
        if (instancia == null) {
            instancia = new PanelConsultaTodosArea();
        }
        return instancia;
...
//---------------------------------------------------------------------END_eventoCombox
    ...
    private static PanelConsultaTodosArea instancia = null;
    //--o--
